...
function [derivKL] = dCholLin(Knd,Kdd,dKnd, Lnd, Ldd, dLnd, indsK, indsL)
%
...
derivKL(1,:) = dChol2Lin(HL, Ldd, Knd, Kdd, dKnd, dKdd);

% column-centered Knd
HK = Knd - repmat(mean(Knd),n,1);
% derivative wrt row (of X) for L
derivKL(2,:) = dChol2Lin(HK, Kdd, Lnd, Ldd, dLnd, dLdd);
