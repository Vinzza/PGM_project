...
\end{tikzpicture}  
\caption{Representation of a distribution $P$ and the different projections on the exponential families $\zD P$ and $\zD G$. We have represent, on the paths between the distributions, the quantity associated to the Kullback-Leibler between those distributions.}\label{fig:pythagorean}
\end{figure}
